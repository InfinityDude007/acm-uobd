...
//         // Expecting data to look like { upcoming_events: [...], past_events: [...] }
...
//             const success = await handleRegistration(event.id, formData);
//             if (success) {
//                 setShowModal(false);
...
//                     <img 
//                         src={event.thumbnail || '/default-event-image.jpg'} 
...
//                 {/* Registration Modal */}
//                 {showModal && (
//                     <div className="modal-backdrop show" onClick={() => !submitting && setShowModal(false)}>
