...
//                   <Box display="flex" alignItems="center" p={2} sx={{ backgroundColor: "#f9fafb", borderRadius: "12px" }}>
//                     <CalendarToday sx={{ fontSize: 24, mr: 2, color: "#1363c6" }} />
//                     <Box>
//                       <Typography variant="caption" sx={{ color: "#6b7280", fontWeight: 600 }}>Date</Typography>
//                       <Typography variant="body1" sx={{ fontFamily: '"Ubuntu", sans-serif', fontWeight: 600 }}>
//                         {formatDate(event.date)}
//                       </Typography>
//                     </Box>
//                   </Box>
...
//                 <Grid item xs={12} sm={6}>
//                   <Box display="flex" alignItems="center" p={2} sx={{ backgroundColor: "#f9fafb", borderRadius: "12px" }}>
//                     <AccessTime sx={{ fontSize: 24, mr: 2, color: "#1363c6" }} />
//                     <Box>
//                       <Typography variant="caption" sx={{ color: "#6b7280", fontWeight: 600 }}>Time</Typography>
//                       <Typography variant="body1" sx={{ fontFamily: '"Ubuntu", sans-serif', fontWeight: 600 }}>
//                         {formatTime(event.date)}
//                       </Typography>
//                     </Box>
...
//                   <Grid item xs={12}>
//                     <Box display="flex" alignItems="center" p={2} sx={{ backgroundColor: "#f9fafb", borderRadius: "12px" }}>
//                       <LocationOn sx={{ fontSize: 24, mr: 2, color: "#1363c6" }} />
//                       <Box>
//                         <Typography variant="caption" sx={{ color: "#6b7280", fontWeight: 600 }}>Location</Typography>
//                         <Typography variant="body1" sx={{ fontFamily: '"Ubuntu", sans-serif', fontWeight: 600 }}>
//                           {event.location}
//                         </Typography>
//                       </Box>
...
//               <Box mb={3}>
//                 <Typography variant="h6" gutterBottom sx={{ fontFamily: '"Ubuntu", sans-serif', fontWeight: 700, color: "#1363c6", mb: 2 }}>
//                   About this event
//                 </Typography>
//                 <Typography variant="body1" sx={{ fontFamily: '"Ubuntu", sans-serif', lineHeight: 1.8, color: "#374151" }}>
//                   {event.description}
//                 </Typography>
//               </Box>
...
//             </Box>
//             <IconButton
//               onClick={() => !submitting && setRegistrationModalOpen(false)}
//               disabled={submitting}
//               sx={{ 
//                 position: 'absolute', 
//                 right: 16, 
